...
public class MainActivity extends Activity implements View.OnClickListener, CameraSurfaceView.OnTextureChangedListener {
    ...
    protected String detModelPath = "en_PP-OCRv3_det_slim_infer.nb";
    protected String recModelPath = "en_PP-OCRv3_rec_slim_infer.nb";
    protected String clsModelPath = "ch_ppocr_mobile_v2.0_cls_slim_opt.nb";
    protected String labelPath = "en_dict.txt";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_shutter:
                @SuppressLint("SimpleDateFormat") SimpleDateFormat date = new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss");
                synchronized (this) {
                    this.savedImagePath = Utils.getDCIMDirectory() + File.separator + date.format(new Date()).toString() + ".png";
                }
                Toast.makeText(MainActivity.this, "Save snapshot to " + this.savedImagePath, Toast.LENGTH_SHORT).show();
                break;
        }
    }
...
//        }
        this.savedImagePath = Utils.getDCIMDirectory() + File.separator + "result.jpg";
