...
public class Predictor {
    ...
    public boolean init(MenuScannerFragment appCtx, String modelPath, String labelPath) {
    ...
    protected boolean loadModel(MenuScannerFragment appCtx, String modelPath, int cpuThreadNum, String cpuPowerMode) {
